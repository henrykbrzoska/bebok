...
pub use provider::{
    ...
    ProviderAdapter, ProviderErrorKind, Sampling, StreamEvent, StreamResult, Thinking, ToolCall,
    ToolDef, ToolResult, Usage, adapter_for, build_provider, classify_http,
