...
pub use model::{
    BuildTestMode, CodeMapConfig, DEFAULT_CODE_MAP_MAX_DEPTH, DEFAULT_CODE_MAP_MAX_TOKENS,
    DEFAULT_CONTEXT_BUDGET, DEFAULT_DELEGATION_MAX_CONCURRENT, DEFAULT_MAX_TOKENS, DEFAULT_MODEL,
    DEFAULT_TOOL_OUTPUT_CAP, DelegationConfig, FleetConfig, FleetMember, MAX_CUSTOM_CSS_FILES,
    MAX_CUSTOM_CSS_LEN, MAX_DELEGATION_MAX_CONCURRENT, ResolvedConfig, ResolvedConfigBuilder,
    UiConfig,
};

// --- loader (load/load_with_global/apply/apply_file/merge_providers/...) ---
pub use loader::{
    apply, apply_code_map, apply_delegation, apply_file, global_config_path, load,
